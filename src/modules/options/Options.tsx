  ...
  return (
    <section className={styles.options}>
      ...
      <article className={styles.cards}>
        <Card title={title1} description={description1} icon={icon1} price={price1}/>
        <Card title={title2} description={description2} icon={icon2} price={price2}/>
        <Card title={title3} description={description3} icon={icon3} price={price3}/>
      </article>
      <article className={styles.pack}>
        <Card title={packTitle} description={packDescription} price={packPrice} variant="xl" />
      </article>
    </section>
  );
}
